...
public class RenderUtil
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) ShrimpHack.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
    ...
    public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
        double x = (double) blockPos.getX() - mc.getRenderManager().renderViewEntity.posY;
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double) x - mc.getRenderManager().renderViewEntity.posX, (double) y - mc.getRenderManager().renderViewEntity.posY, (double) z - mc.getRenderManager().renderViewEntity.posZ);
