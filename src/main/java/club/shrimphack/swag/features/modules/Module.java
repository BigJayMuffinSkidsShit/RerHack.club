...
public class Module
    ...
    public void enable() {
        ...
        this.onToggle();
        this.onEnable();
        Command.sendOverwriteMessage(ChatFormatting.GREEN + this.getName() + ChatFormatting.RESET +" has been enabled.",1, true);
    ...
    public void disable() {
        Command.sendOverwriteMessage(ChatFormatting.RED + this.getName() + ChatFormatting.RESET + " has been disabled.", 1, true);
