...
import club.shrimphack.swag.event.events.ProcessRightClickBlockEvent;
...
public class Offhand extends Module
{
    ...
    public void doSwitch() {
        ...
        if (this.antiGappleFail.getValue() && this.currentMode == Mode2.GAPPLES && ((!EntityUtil.isSafe((Entity)Offhand.mc.player) && EntityUtil.getHealth((Entity)Offhand.mc.player, true) <= this.crystalHealth.getValue()) || EntityUtil.getHealth((Entity)Offhand.mc.player, true) <= this.crystalHoleHealth.getValue())) {
